...
_G.packer_plugins = {
  ...
  ["cmp-emoji"] = {
    loaded = true,
    path = "/home/ap/.local/share/nvim/site/pack/packer/start/cmp-emoji",
  ...
  ["cmp-nvim-ultisnips"] = {
    loaded = true,
    path = "/home/ap/.local/share/nvim/site/pack/packer/start/cmp-nvim-ultisnips",
  ...
  ["cmp-spell"] = {
    loaded = true,
    path = "/home/ap/.local/share/nvim/site/pack/packer/start/cmp-spell",
  ...
  ["vim-snippets"] = {
    loaded = true,
    path = "/home/ap/.local/share/nvim/site/pack/packer/start/vim-snippets",
